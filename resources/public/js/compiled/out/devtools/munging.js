...
var o24853 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24853["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24854 = temp__5455__auto____$1;
return (o24854["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24694__auto__ = f;
return (o__24694__auto__["toString"]).call(o__24694__auto__);
} else {
return "";
}
}catch (e24855){var _ = e24855;
return "";
}});
...
try{var o__24694__auto___24857 = t;
(o__24694__auto___24857["cljs$lang$ctorPrWriter"]).call(o__24694__auto___24857,t,writer);
}catch (e24856){var __24858 = e24856;
}
...
var char_code = (function (){var o__24694__auto__ = (new String(char$));
return (o__24694__auto__["charCodeAt"]).call(o__24694__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24694__auto__ = String;
return (o__24694__auto__["fromCharCode"]).call(o__24694__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24859 = num_code;
switch (G__24859) {
case (1):
return (185);
...
var o__24694__auto__ = String;
return (o__24694__auto__["fromCharCode"]).call(o__24694__auto__,superscript_code);
});
/**
...
}catch (e24861){var _e__24701__auto__ = e24861;
return false;
}})())){
...
var vec__24862 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24862,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o24865 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24865["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24866 = temp__5455__auto____$1;
return (o24866["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___24873 = arguments.length;
var i__4500__auto___24874 = (0);
while(true){
if((i__4500__auto___24874 < len__4499__auto___24873)){
args__4502__auto__.push((arguments[i__4500__auto___24874]));

var G__24875 = (i__4500__auto___24874 + (1));
i__4500__auto___24874 = G__24875;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24869){
var vec__24870 = p__24869;
var ns_detector = cljs.core.nth.call(null,vec__24870,(0),null);
...
var G__24876 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24877 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24876;
remaining_tokens = G__24877;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24867){
var G__24868 = cljs.core.first.call(null,seq24867);
var seq24867__$1 = cljs.core.next.call(null,seq24867);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24868,seq24867__$1);
});
...
var vec__24881 = cljs.core.split_with.call(null,(function (p1__24880_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24880_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24881,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24881,(1),null);
...
var vec__24884 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24884,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24884,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24887 = cljs.core.rest.call(null,remaining_tokens);
var G__24888 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24887;
name_tokens = G__24888;
continue;
} else {
...
var vec__24891 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24891,(0),null);
var arity = cljs.core.nth.call(null,vec__24891,(1),null);
var vec__24894 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24894,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24894,(1),null);
var vec__24897 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24897,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24897,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24897,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24897,(3),null);
...
var vec__24903 = result;
var munged_ns = cljs.core.nth.call(null,vec__24903,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24903,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24903,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24903,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24903,(4),null);
var arity = cljs.core.nth.call(null,vec__24903,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__24907 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__24907,(0),null);
var args = cljs.core.nth.call(null,vec__24907,(1),null);
var vec__24910 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24910,(0),null);
var name = cljs.core.nth.call(null,vec__24910,(1),null);
...
var G__24913 = (arity + (1));
var G__24914 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24915){
var vec__24916 = p__24915;
var arity = cljs.core.nth.call(null,vec__24916,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24916,(1),null);
...
return (function (p1__24919_SHARP_){
return cljs.core.get.call(null,arities,p1__24919_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__24920_SHARP_){
return cljs.core.drop.call(null,(2),p1__24920_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___24927 = arguments.length;
var i__4500__auto___24928 = (0);
while(true){
if((i__4500__auto___24928 < len__4499__auto___24927)){
args__4502__auto__.push((arguments[i__4500__auto___24928]));

var G__24929 = (i__4500__auto___24928 + (1));
i__4500__auto___24928 = G__24929;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24923){
var vec__24924 = p__24923;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24924,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24921){
var G__24922 = cljs.core.first.call(null,seq24921);
var seq24921__$1 = cljs.core.next.call(null,seq24921);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24922,seq24921__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24932__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24932__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24932__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24932__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24933 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24933,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24933,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24933,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24933,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24933,(4),null);
var arity = cljs.core.nth.call(null,vec__24933,(5),null);
...
var o__24694__auto__ = f;
return (o__24694__auto__["getBasis"]).call(o__24694__auto__);
});
/**
...
}catch (e24937){var _e__24701__auto__ = e24937;
...
var G__24938 = (obj[cljs.core.first.call(null,path)]);
var G__24939 = cljs.core.rest.call(null,path);
obj = G__24938;
path = G__24939;
continue;
} else {
...
return (function (accum,p__24940){
var vec__24941 = p__24940;
var bit = cljs.core.nth.call(null,vec__24941,(0),null);
var protocol = cljs.core.nth.call(null,vec__24941,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24944){
var vec__24945 = p__24944;
var ns = cljs.core.nth.call(null,vec__24945,(0),null);
var name = cljs.core.nth.call(null,vec__24945,(1),null);
var selector = cljs.core.nth.call(null,vec__24945,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24950,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24950,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24950,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24948_SHARP_){
return (obj[cljs.core.first.call(null,p1__24948_SHARP_)]);
});})(name,sorted_matches,vec__24950,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1542912630512
