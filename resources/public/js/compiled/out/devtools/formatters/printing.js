...
args__4502__auto__.push((arguments[i__4500__auto___24985]));
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq24981){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__24987_SHARP_){
return !((cljs.core.meta.call(null,p1__24987_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__24988__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e24992){var _e__24701__auto__ = e24992;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e24994){var _e__24701__auto__ = e24994;
return false;
}}
})())){
...
var _STAR_current_state_STAR_24996 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__24997 = opts;
...
var markup_db = cljs.core.get.call(null,map__24997__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_24996;
}});
...
;
var temp__5455__auto___25001 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___25001)){
var managed_print_level_25002 = temp__5455__auto___25001;
var _STAR_print_level_STAR_25000_25003 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_25002;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_25000_25003,managed_print_level_25002,temp__5455__auto___25001,writer,opts,job_fn){
return (function (p1__24999_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__24999_SHARP_,null);
});})(_STAR_print_level_STAR_25000_25003,managed_print_level_25002,temp__5455__auto___25001,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_25000_25003;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1542912630753
