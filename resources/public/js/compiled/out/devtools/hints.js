...
var file = cljs.core.get.call(null,map__24731__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__24731__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__24731__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e24730){var _e = e24730;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___24733 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24733)){
var seen_errors_24734 = temp__5455__auto___24733;
if(cljs.core.truth_(seen_errors_24734.has(self))){
} else {
seen_errors_24734.add(self);

var temp__5457__auto___24735 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24735)){
var sense_24736 = temp__5457__auto___24735;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24736)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1542912630060
