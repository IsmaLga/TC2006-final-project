...
if(typeof devtools.toolbox.t_devtools$toolbox25670 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox25670 = (function (obj,header,style,tag,meta25671){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox25670.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25672,meta25671__$1){
var self__ = this;
var _25672__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox25670(self__.obj,self__.header,self__.style,self__.tag,meta25671__$1));
});

devtools.toolbox.t_devtools$toolbox25670.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25672){
var self__ = this;
var _25672__$1 = this;
return self__.meta25671;
});

devtools.toolbox.t_devtools$toolbox25670.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox25670.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox25670.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox25670.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox25670.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta25671","meta25671",-971600946,null)], null);
});

devtools.toolbox.t_devtools$toolbox25670.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox25670.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox25670";

devtools.toolbox.t_devtools$toolbox25670.cljs$lang$ctorPrWriter = (function (this__4161__auto__,writer__4162__auto__,opt__4163__auto__){
return cljs.core._write.call(null,writer__4162__auto__,"devtools.toolbox/t_devtools$toolbox25670");
});

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox25670.
 */
devtools.toolbox.__GT_t_devtools$toolbox25670 = (function devtools$toolbox$__GT_t_devtools$toolbox25670(obj__$1,header__$1,style__$1,tag__$1,meta25671){
return (new devtools.toolbox.t_devtools$toolbox25670(obj__$1,header__$1,style__$1,tag__$1,meta25671));
});

}

return (new devtools.toolbox.t_devtools$toolbox25670(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1542912632564
