...
var G__25693 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__25693;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__25694 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__25694,ch);
...
if(("\\" === ch__$1)){
var ch_25695__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_25695__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_25695__$2);
} else {
}

var G__25696 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__25696;
continue;
}
}
...
var vec__25704 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25704,(0),null);
var start_column = cljs.core.nth.call(null,vec__25704,(1),null);
...
var G__25707 = cljs.core.conj_BANG_.call(null,a,form);
a = G__25707;
continue;
}
}
...
var _STAR_read_delim_STAR_25708 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_25708;
}});
/**
...
var vec__25721 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25721,(0),null);
var start_column = cljs.core.nth.call(null,vec__25721,(1),null);
...
var vec__25724 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25724,(0),null);
var end_column = cljs.core.nth.call(null,vec__25724,(1),null);
...
var sb = (function (){var G__25727 = (new goog.string.StringBuffer());
G__25727.append(initch);
...
var G__25729 = (function (){var G__25728 = sb;
G__25728.append(ch);

return G__25728;
})();
var G__25730 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__25729;
ch = G__25730;
continue;
}
...
switch (G__25733) {
case "\\":
var G__25737 = (function (){var G__25734 = sb;
G__25734.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__25734;
})();
var G__25738 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__25737;
ch = G__25738;
continue;
...
break;
default:
var G__25739 = (function (){var G__25735 = sb;
G__25735.append(ch);

return G__25735;
})();
var G__25740 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__25739;
ch = G__25740;
continue;
...
var vec__25741 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25741,(0),null);
var end_column = cljs.core.nth.call(null,vec__25741,(1),null);
...
var vec__25744 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__25749 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25749,(0),null);
var column = cljs.core.nth.call(null,vec__25749,(1),null);
...
var vec__25754 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25754,(0),null);
var column = cljs.core.nth.call(null,vec__25754,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__25759 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25759,(0),null);
var start_column = cljs.core.nth.call(null,vec__25759,(1),null);
...
var vec__25762 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25762,(0),null);
var end_column = cljs.core.nth.call(null,vec__25762,(1),null);
...
var G__25765 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__25765,true,null,opts,pending_forms);
...
var G__25766 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__25766)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__25766)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__25766)){
...
var _STAR_suppress_read_STAR_25767 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_25767;
}});
...
var G__25768 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__25768,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__25768,rdr,first_line);
...
var G__25772 = matched;
var G__25773 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__25772;
finished = G__25773;
continue;
} else {
...
var _STAR_suppress_read_STAR_25774 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_25774;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env25775 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__25776 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__25776,"(");
...
var G__25777 = (i + (1));
var G__25778 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env25775;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__25779 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__25779);
...
var G__25780 = cljs.core.next.call(null,s__$1);
var G__25781 = ret;
s__$1 = G__25780;
r = G__25781;
continue;
...
var G__25782 = cljs.core.next.call(null,s);
var G__25783 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__25782;
key_vals = G__25783;
continue;
} else {
...
var gensym_env25787 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env25787;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__25788 = token;
var G__25788__$1 = (((G__25788 == null))?null:cljs.core.subs.call(null,G__25788,(1)));
var G__25788__$2 = (((G__25788__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__25788__$1));
var G__25788__$3 = (((G__25788__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__25788__$2));
var G__25788__$4 = (((G__25788__$3 == null))?null:cljs.core.symbol.call(null,G__25788__$3));
if((G__25788__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__25788__$4);
}
})():(function (){var G__25789 = token;
var G__25789__$1 = (((G__25789 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__25789));
if((G__25789__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__25789__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e25796){if((e25796 instanceof Error)){
var e = e25796;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__25800,reader){
...
var eof = cljs.core.get.call(null,map__25801__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq25807){
var G__25808 = cljs.core.first.call(null,seq25807);
var seq25807__$1 = cljs.core.next.call(null,seq25807);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25808,seq25807__$1);
});


//# sourceMappingURL=reader.js.map?rel=1542912633015
