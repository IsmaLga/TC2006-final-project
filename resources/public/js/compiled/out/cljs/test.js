...
var G__23623 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__23623,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__23623;
}
});
...
var len__4499__auto___23628 = arguments.length;
var i__4500__auto___23629 = (0);
while(true){
if((i__4500__auto___23629 < len__4499__auto___23628)){
args__4502__auto__.push((arguments[i__4500__auto___23629]));

var G__23630 = (i__4500__auto___23629 + (1));
i__4500__auto___23629 = G__23630;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq23625){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23626,G__23627,seq23625__$2);
});
...
var file = cljs.core.get.call(null,map__23632__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__23632__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__23632__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__23632,map__23632__$1,file,line,column){
return (function (p1__23631_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__23631_SHARP_));
});})(map__23632,map__23632__$1,file,line,column))
...
var temp__5457__auto___23634 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___23634)){
var message_23635 = temp__5457__auto___23634;
cljs.core.println.call(null,message_23635);
} else {
}
...
var temp__5457__auto___23636 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___23636)){
var message_23637 = temp__5457__auto___23636;
cljs.core.println.call(null,message_23637);
} else {
}
...
var output_dir__$1 = (function (){var G__23638 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23638),"/"].join('');
} else {
return G__23638;
}
})();
...
var G__23640 = exception.stack;
var G__23640__$1 = (((G__23640 == null))?null:clojure.string.split_lines.call(null,G__23640));
var G__23640__$2 = (((G__23640__$1 == null))?null:cljs.core.get.call(null,G__23640__$1,depth));
if((G__23640__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__23640__$2);
}
} else {
...
var vec__23641 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__23641,(0),null);
var column = cljs.core.nth.call(null,vec__23641,(1),null);
var vec__23644 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__23644,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__23644,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__23644,(2),null);
...
var m__$1 = (function (){var G__23647 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__23651 = (function (){var G__23650 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__23650);
} else {
return G__23650;
}
})();
...
return cljs.core.vary_meta.call(null,G__23652,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__23656 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__23656,(0),null);
var types = vec__23656;
...
return cljs.core.map.call(null,(function (p__23659){
var vec__23660 = p__23659;
var ns = cljs.core.nth.call(null,vec__23660,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__23660,(1),null);
return ((function (vec__23660,ns,vars__$1){
return (function (){
...
var G__23663 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__23663,G__23663__$1,env,once_fixtures,each_fixtures,vec__23660,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__23663,G__23663__$1,env,once_fixtures,each_fixtures,vec__23660,ns,vars__$1){
return (function (){
var seq__23664 = cljs.core.seq.call(null,vars__$1);
var chunk__23665 = null;
var count__23666 = (0);
var i__23667 = (0);
while(true){
if((i__23667 < count__23666)){
var v = cljs.core._nth.call(null,chunk__23665,i__23667);
var temp__5457__auto___23669 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___23669)){
var t_23670 = temp__5457__auto___23669;
each_fixture_fn.call(null,((function (seq__23664,chunk__23665,count__23666,i__23667,t_23670,temp__5457__auto___23669,v,each_fixture_fn,G__23663,G__23663__$1,env,once_fixtures,each_fixtures,vec__23660,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23670)));
});})(seq__23664,chunk__23665,count__23666,i__23667,t_23670,temp__5457__auto___23669,v,each_fixture_fn,G__23663,G__23663__$1,env,once_fixtures,each_fixtures,vec__23660,ns,vars__$1))
);
} else {
}


var G__23671 = seq__23664;
var G__23672 = chunk__23665;
var G__23673 = count__23666;
var G__23674 = (i__23667 + (1));
seq__23664 = G__23671;
chunk__23665 = G__23672;
count__23666 = G__23673;
i__23667 = G__23674;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__23664);
if(temp__5457__auto__){
var seq__23664__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__23664__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__23664__$1);
var G__23675 = cljs.core.chunk_rest.call(null,seq__23664__$1);
var G__23676 = c__4319__auto__;
var G__23677 = cljs.core.count.call(null,c__4319__auto__);
var G__23678 = (0);
seq__23664 = G__23675;
chunk__23665 = G__23676;
count__23666 = G__23677;
i__23667 = G__23678;
continue;
} else {
var v = cljs.core.first.call(null,seq__23664__$1);
var temp__5457__auto___23679__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___23679__$1)){
var t_23680 = temp__5457__auto___23679__$1;
each_fixture_fn.call(null,((function (seq__23664,chunk__23665,count__23666,i__23667,t_23680,temp__5457__auto___23679__$1,v,seq__23664__$1,temp__5457__auto__,each_fixture_fn,G__23663,G__23663__$1,env,once_fixtures,each_fixtures,vec__23660,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23680)));
});})(seq__23664,chunk__23665,count__23666,i__23667,t_23680,temp__5457__auto___23679__$1,v,seq__23664__$1,temp__5457__auto__,each_fixture_fn,G__23663,G__23663__$1,env,once_fixtures,each_fixtures,vec__23660,ns,vars__$1))
);
} else {
}


var G__23681 = cljs.core.next.call(null,seq__23664__$1);
var G__23682 = null;
var G__23683 = (0);
var G__23684 = (0);
seq__23664 = G__23681;
chunk__23665 = G__23682;
count__23666 = G__23683;
i__23667 = G__23684;
continue;
}
} else {
...
});})(each_fixture_fn,G__23663,G__23663__$1,env,once_fixtures,each_fixtures,vec__23660,ns,vars__$1))
);
});})(each_fixture_fn,G__23663,G__23663__$1,env,once_fixtures,each_fixtures,vec__23660,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23663__$1)].join('')));

}
})());
});
;})(vec__23660,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1542912628891
