...
return (new CustomEvent(event_name,(function (){var obj29314 = {"detail":data};
return obj29314;
})()));
} else {
...
var f = (function (){var pred__29321 = cljs.core._EQ_;
var expr__29322 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29321.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29322))){
return ((function (pred__29321,expr__29322){
return (function (p1__29315_SHARP_){
return console.warn(p1__29315_SHARP_);
});
;})(pred__29321,expr__29322))
} else {
if(cljs.core.truth_(pred__29321.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29322))){
return ((function (pred__29321,expr__29322){
return (function (p1__29316_SHARP_){
return console.debug(p1__29316_SHARP_);
});
;})(pred__29321,expr__29322))
} else {
if(cljs.core.truth_(pred__29321.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29322))){
return ((function (pred__29321,expr__29322){
return (function (p1__29317_SHARP_){
return console.error(p1__29317_SHARP_);
});
;})(pred__29321,expr__29322))
} else {
return ((function (pred__29321,expr__29322){
return (function (p1__29318_SHARP_){
return console.log(p1__29318_SHARP_);
});
;})(pred__29321,expr__29322))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29325){
...
var opts = map__29326__$1;
var eval_fn = cljs.core.get.call(null,map__29326__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__29328_SHARP_){
return new_def.callback(p1__29328_SHARP_);
});})(new_def))
);
...
var vec__29330 = p__29329;
var ky = cljs.core.nth.call(null,vec__29330,(0),null);
var v = cljs.core.nth.call(null,vec__29330,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1542912635928
